            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-c" class="swal2-input" placeholder="Estudiante" value="${celdas[2].textContent}">
                        <input id="swal-d" class="swal2-input" placeholder="Trabajo1" value="${celdas[3].textContent}">
                        <input id="swal-e" class="swal2-input" placeholder="Trabajo2" value="${celdas[4].textContent}">
                        <input id="swal-f" class="swal2-input" placeholder="Trabajo3" value="${celdas[5].textContent}">
                        <input id="swal-g" class="swal2-input" placeholder="Evaluacion" value="${celdas[6].textContent}">
                    `,
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                ...
                html: `
                    ...
                    <input id="swal-c" class="swal2-input" placeholder="Estudiante">
                    <input id="swal-d" class="swal2-input" placeholder="Trabajo1">
                    <input id="swal-e" class="swal2-input" placeholder="Trabajo2">
                    <input id="swal-f" class="swal2-input" placeholder="Trabajo3">
                    <input id="swal-g" class="swal2-input" placeholder="Evaluacion">
                `,
                showCancelButton: true,
                ...
                preConfirm: () => {
                    ...
                    let g = document.getElementById("swal-g").value;
                    if (!b || !c || !d || !e) {
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        icon: "success",
                        title: "Nota Agregada",
                        text: `las Notas de ${result.value.c} ha sido agregada exitosamente.`,
