            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-nombre" class="swal2-input" placeholder="Horario" value="${celdas[1].textContent}">
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                ...
                html: `
                    ...
                    <input id="swal-nombre" class="swal2-input" placeholder="Horario">
                ...
                preConfirm: () => {
                    ...
                    if (!id || !nombre || !apellido) {
                        Swal.showValidationMessage("Los campos Identificación, Horario, curso y jornada son obligatorios");
                        return false;
                    }
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        text: `El horario ${result.value.id} ha sido agregado exitosamente.`,
