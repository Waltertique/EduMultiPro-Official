            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-segundo-apellido" class="swal2-input" placeholder="Profesor" value="${celdas[4].textContent}">
                    `,
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                ...
                html: `
                    ...
                    <input id="swal-segundo-apellido" class="swal2-input" placeholder="Profesor">
                `,
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        icon: "success",
                        title: "Aula Agregada",
                        text: `La Aula ${result.value.id} ha sido agregada exitosamente.`,
