$(document).ready(function(){
            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-nombre" class="swal2-input" placeholder="Curso" value="${celdas[1].textContent}">
                        <input id="swal-segundo-nombre" class="swal2-input" placeholder="Grado" value="${celdas[2].textContent}">
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                ...
                html: `
                    ...
                    <input id="swal-nombre" class="swal2-input" placeholder="Curso">
                    <input id="swal-segundo-nombre" class="swal2-input" placeholder="Grado">
                ...
                preConfirm: () => {
                    ...
                    if (!id || !nombre || !apellido) {
                        Swal.showValidationMessage("Los campos Identificación, curso, grado y jornada son obligatorios");
                        return false;
                    }
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        text: `El curso ${result.value.id} ha sido agregado exitosamente.`,
    ...
    document.querySelectorAll('.info').forEach(boton => {
        boton.addEventListener('click', function () {
            window.location.href = '../admin/3.3cur.html';
        });
    });