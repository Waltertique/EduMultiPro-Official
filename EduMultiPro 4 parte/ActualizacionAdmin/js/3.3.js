$(document).ready(function(){
    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-nombre" class="swal2-input" placeholder="Salon" value="${celdas[1].textContent}">
                        <input id="swal-segundo-nombre" class="swal2-input" placeholder="Materia" value="${celdas[2].textContent}">
                        <input id="swal-apellido" class="swal2-input" placeholder="Profesor" value="${celdas[3].textContent}">
                        <input id="swal-segundo-apellido" class="swal2-input" placeholder="Descripcion" value="${celdas[4].textContent}">
                    `,
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                title: "Crear Nuevo Materia",
                html: `
                    <input id="swal-id" class="swal2-input" placeholder="ID">
                    <input id="swal-nombre" class="swal2-input" placeholder="Salon">
                    <input id="swal-segundo-nombre" class="swal2-input" placeholder="Materia">
                    <input id="swal-apellido" class="swal2-input" placeholder="Profesor">
                    <input id="swal-segundo-apellido" class="swal2-input" placeholder="Descripcion">
                `,
                showCancelButton: true,
                ...
                preConfirm: () => {
                    ...
                    if (!id || !nombre || !apellido) {
                        Swal.showValidationMessage("Los campos Identificación, Salon,Materia, Profespr y Descripcion son obligatorios");
                        return false;
                    }
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        text: `La Materia ${result.value.id} ha sido agregado exitosamente.`,
