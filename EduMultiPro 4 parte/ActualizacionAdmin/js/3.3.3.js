            ...
            fila.querySelector(".modificar").addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input id="swal-segundo-nombre" class="swal2-input" placeholder="Director" value="${celdas[2].textContent}">
                        <input id="swal-apellido" class="swal2-input" placeholder="Curso" value="${celdas[3].textContent}">
                        <input id="swal-segundo-apellido" class="swal2-input" placeholder="Grado" value="${celdas[4].textContent}">
                    `,
        ...
        document.querySelector(".crear").addEventListener("click", function () {
            Swal.fire({
                ...
                html: `
                    ...
                    <input id="swal-segundo-nombre" class="swal2-input" placeholder="Director">
                    <input id="swal-apellido" class="swal2-input" placeholder="Curso">
                    <input id="swal-segundo-apellido" class="swal2-input" placeholder="Grado">
                `,
                showCancelButton: true,
                ...
                preConfirm: () => {
                    ...
                    if (!id || !nombre || !apellido) {
                        Swal.showValidationMessage("Los campos Identificación, Director, Curso y Grado son obligatorios");
                        return false;
                    }
