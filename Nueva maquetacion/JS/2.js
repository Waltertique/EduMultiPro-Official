...
// Parte 2
document.getElementById('imgPrincipal').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/3-ApartadoNoticia.html';
});

document.getElementById('imgSecundario').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/3-ApartadoNoticia.html';
});

document.getElementById('imgterciaria').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/3-ApartadoNoticia.html';
});

document.getElementById('imgCuartaria').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/3-ApartadoNoticia.html';
});
