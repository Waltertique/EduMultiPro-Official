                ...
                <div className="container-fluid" id="centro1">
                    ...
                    <div className="row" id='contenido'>
                        ...
                        <div className="col-10" id="contenidoTabla">
                            ...
                            <div className="carda">
                                <Link to="/Materias" ><div className="targeta"><i className="fa-solid fa-book"></i><h1>Materia</h1></div></Link>
                                
                                <Link to="/Grados" ><div className="targeta"><i className="fa-solid fa-temperature-low"></i><h1>Grado</h1></div></Link>

                                <Link to="/Jornadas" ><div className="targeta"><i className="fa-solid fa-clock"></i><h1>Jornada</h1></div></Link>
